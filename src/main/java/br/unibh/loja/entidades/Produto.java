...
public class Produto {
	...
	@Column(length=(int) 14.2, nullable=false)
	...
	public String toString() {
		return "Produto [id=" + id + ", nome=" + nome + ", descricao=" + descricao + ", categoria=" + categoria
				+ ", preco=" + preco + ", fabricante=" + fabricante + ", hashCode()=" + hashCode() + ", getId()="
				+ getId() + ", getNome()=" + getNome() + ", getDescricao()=" + getDescricao() + ", getCategoria()="
				+ getCategoria() + ", getPreco()=" + getPreco() + ", getFabricante()=" + getFabricante()
